...
public class RecordingActivity extends AppCompatThemeActivity {
    ...
    protected void onResume() {
        ...
        RecordingService.startService(this, Storage.getDocumentName(recording.targetUri), r, encoder != null, duration);
    ...
    void stopRecording(String status) {
        ...
        RecordingService.startService(this, Storage.getDocumentName(recording.targetUri), false, encoder != null, duration);
    ...
    void startRecording() {
        try {
            ...
            RecordingService.startService(this, Storage.getDocumentName(recording.targetUri), true, encoder != null, duration);
        } catch (RuntimeException e) {
    ...
    void updateSamples(long samplesTime) {
        ...
        RecordingService.startService(this, Storage.getDocumentName(recording.targetUri), recording.thread != null, encoder != null, duration);
    }
    ...
    void encoding(final Runnable done) {
        ...
        final Runnable last = new Runnable() {
            ...
            public void run() {
                ...
                edit.putString(AudioApplication.PREFERENCE_LAST, Storage.getDocumentName(recording.targetUri));
                edit.commit();
                done.run();
            }
        };
    ...
    void encoding(final FileEncoder encoder, final OnFlyEncoding fly, final Runnable last) {
        RecordingService.startService(this, Storage.getDocumentName(fly.targetUri), recording.thread != null, encoder != null, duration);

        final ProgressDialog d = new ProgressDialog(this);
        d.setTitle(R.string.encoding_title);
        d.setMessage(".../" + Storage.getDocumentName(recording.targetUri));
        d.setMax(100);
